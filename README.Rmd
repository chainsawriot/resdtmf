...
The goal of Responsible Document-term Matrix Format (resdtmf) is to create a machine-readable, plain-text and exchangable file format of document-term matrices (dtm, or in quanteda's parlance, document-feature matrices).
