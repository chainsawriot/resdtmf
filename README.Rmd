...
The goal of Responsible Document-term Matrix Format (`resdtmf`, pronounced as "res-dumf" /ɹɪˈzdəmf/) is to create a machine-readable, plain-text and exchangable file format of document-term matrices (dtm, or in quanteda's parlance, document-feature matrices).

Currently, there is no standard format for document-term matrics. A resdtmf file is a JSON file with five components:
